				...
				<div class="searchbox update" style="height:0px;">
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td>
								区域1:<input name="areaprice" type="radio" onclick="calcdeliveryprice();" value="<s:property value="areaprice01"/>"/>&nbsp;&nbsp;
								区域2:<input name="areaprice" type="radio" onclick="calcdeliveryprice();" value="<s:property value="areaprice02"/>"/>&nbsp;&nbsp;
								区域3:<input name="areaprice" type="radio" onclick="calcdeliveryprice();" value="<s:property value="areaprice03"/>"/>&nbsp;&nbsp;
							</td>
							<td>
								区域4:<input name="areaprice" type="radio" onclick="calcdeliveryprice();" value="<s:property value="areaprice04"/>"/>&nbsp;&nbsp;
								区域5:<input name="areaprice" type="radio" onclick="calcdeliveryprice();" value="<s:property value="areaprice05"/>"/>&nbsp;&nbsp;
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updWarehouserptDto.res03" id="res03" cssStyle="width:120px;" maxlength="16" theme="simple" onblur="calcdeliveryprice();"></s:textfield>
								</div>
								<div class="box1_right"></div>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updWarehouserptDto.incamount" id="incamount" cssStyle="width:120px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updWarehouserptDto.expressincamount" id="expressincamount" cssStyle="width:120px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="btn">
									<div class="box1_left"></div>
									<div class="box1_center">
										<input class="input120" type="button" style="width:60px" value="配货单" onclick="exportData(1);"/>
									</div>
									<div class="box1_right"></div>
								</div>
							</td>
							<td>
								<div class="btn">
									<div class="box1_left"></div>
									<div class="box1_center">
										<input class="input120" type="button" style="width:60px" value="新配货单" onclick="exportData(10);"/>
									</div>
									<div class="box1_right"></div>
								</div>
							</td>
							<td>
								<div class="btn">
									<div class="box1_left"></div>
									<div class="box1_center">
										<input class="input120" type="button" style="width:60px" value="出货明细" onclick="exportData(2);"/>
									</div>
									<div class="box1_right"></div>
								</div>
							</td>
							<td>
								<div class="btn">
									<div class="box1_left"></div>
									<div class="box1_center">
										<input class="input120" type="button" style="width:60px" value="新出货单" onclick="exportData(20);"/>
									</div>
									<div class="box1_right"></div>
								</div>
							</td>
							...
							<s:else>
								<td id="barcodeTd">
									...
									<div class="btn">
										<div class="box1_left"></div>
										<div class="box1_center">
											<input class="input120" type="button" style="width:100px" value="条形码出库" onclick="showBarcodeOut();"/>
										</div>
										<div class="box1_right"></div>
									</div>
								</td>
							<td>
								<div class="btn">
									<div class="box1_left"></div>
									<div class="box1_center">
										<input class="input80" type="button" value="用友导出" onclick="OGDlistOut(3);"/>
									</div>
									<div class="box1_right"></div>
								</div>
							</td>
