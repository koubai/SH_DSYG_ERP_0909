		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
						...
						<table class="trade_tab" width="80%" border="0">
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.companycn" onblur="changeAccount('both', 'companycn');" id="companycn" cssStyle="width:250px;" maxlength="128" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.companyen" onblur="changeAccount('single', 'companyen');" id="companyen" cssStyle="width:250px;" maxlength="128" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1">
										<div class="box1_left"></div>
										<div class="box1_center">
											<s:textfield name="addCustomerOnlineDto.department" onblur="changeAccount('single', 'department');" id="department" cssStyle="width:250px;" maxlength="64" theme="simple"></s:textfield>
										</div>
										<div class="box1_right"></div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.name" onblur="changeAccount('both', 'name');" id="name" cssStyle="width:250px;" maxlength="32" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.postcode" onblur="changeAccount('single', 'postcode');" id="postcode" cssStyle="width:250px;" maxlength="32" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.address" onblur="changeAccount('both', 'address');" id="address" cssStyle="width:250px;" maxlength="128" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerOnlineDto.tell" onblur="changeAccount('both', 'tell');" id="tell" cssStyle="width:250px;" maxlength="32" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
			...
			<tr>
				...
				<td width="500">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addCustomerOnlineDto.res04" id="res04" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
