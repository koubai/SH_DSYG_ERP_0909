		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				...
				<td width="500">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updateCustomerDto.res04" id="res04" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				<td width="120"><font color="red"></font>用友客户编号（发展）</td>
				<td width="500">
					<div class="box1_left"></div>
					<div class="box1_center">
