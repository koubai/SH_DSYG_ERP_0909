...
<div id="qaDiv" style="position:absolute; margin-top:10px;margin-left:600px; display: none;"><img width="19" height="19" style="cursor: pointer;" onclick="goQa();" alt="" src="<%=request.getContextPath()%>/images/mail.jpg" /></div>
