					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td align="right">
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item18" id="item18" maxlength="15" cssStyle="width:180px;" theme="simple" disabled="true"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>						
						<tr>
							...
							<td align="right">
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item16" id="item16" maxlength="15" cssStyle="width:180px;" theme="simple" disabled="true"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>						
						<tr>
							...
							<td align="right">
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item17" id="item17" maxlength="15" cssStyle="width:180px;" theme="simple" disabled="true"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>												
