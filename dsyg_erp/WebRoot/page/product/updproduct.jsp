	...
	<div id="containermain">
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
				...
				<s:hidden name="updProductDto.item13" id="item13"></s:hidden>
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td>
								...
								<div class="box1_center">
									<select name="updProductDto.fieldno" id="fieldno" style="width: 300px;" onchange="changefieldno(this);">
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<select name="updProductDto.rank" id="rank" style="width:300px;">
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item10" id="item10" maxlength="32" cssStyle="width:300px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
							<td align="right">
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.salesprice" id="salesprice" maxlength="64" cssStyle="width:300px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item11" id="item11" maxlength="32" cssStyle="width:300px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
											...
											<s:if test='%{featureList01[#st1.index].codename == "code01_item04" && #st1.index == 3}'>
												...
												<s:iterator value="dictList" id="dictList" status="st2">
													<s:if test='%{updProductDto.fieldno == "01" && featureList01[#st1.index].codename == "code01_item04" && #st1.index == 3}'>
														<input id="code01_0<s:property value="#st1.index + 1"/>" name='code01_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item04}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><label><s:property value="fieldname"/></label>
													</s:if>
													<s:else>
											...
											<s:else>
												<s:iterator value="dictList" id="dictList" status="st2">
													<s:if test='%{updProductDto.fieldno == "01" && featureList01[#st1.index].codename == "code01_item01" && #st1.index == 0}'>
														<input id="code01_0<s:property value="#st1.index + 1"/>" name='code01_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item01}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><label><s:property value="fieldname"/></label>
													</s:if>
													<s:elseif test='%{updProductDto.fieldno == "01" && featureList01[#st1.index].codename == "code01_item02" && #st1.index == 1}'>
														<input id="code01_0<s:property value="#st1.index + 1"/>" name='code01_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item02}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><label><s:property value="fieldname"/></label>
													</s:elseif>
													<s:elseif test='%{updProductDto.fieldno == "01" && featureList01[#st1.index].codename == "code01_item03" && #st1.index == 2}'>
														<input id="code01_0<s:property value="#st1.index + 1"/>" name='code01_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item03}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><label><s:property value="fieldname"/></label>
													</s:elseif>
													<s:else>
														<input id="code01_0<s:property value="#st1.index + 1"/>" name='code01_item0<s:property value="#st1.index + 1"/>' value='<s:property value="code"/>' type="radio" /><label><s:property value="fieldname"/></label>
													</s:else>
											...
											<s:if test='%{featureList02[#st1.index].codename == "code02_item06" && #st1.index == 5}'>
												...
												<s:iterator value="dictList" id="dictList" status="st2">
													<s:if test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item06" && #st1.index == 5}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item06}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:if>
													<s:else>
											...
											<s:else>
												<s:iterator value="dictList" id="dictList" status="st2">
													<s:if test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item01" && #st1.index == 0}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item01}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:if>
													<s:elseif test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item02" && #st1.index == 1}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item02}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:elseif>
													<s:elseif test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item03" && #st1.index == 2}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item03}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:elseif>
													<s:elseif test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item04" && #st1.index == 3}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item04}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:elseif>
													<s:elseif test='%{updProductDto.fieldno == "02" && featureList02[#st1.index].codename == "code02_item05" && #st1.index == 4}'>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' <s:if test='%{dictList[#st2.index].code == updProductDto.item05}'>checked</s:if> value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:elseif>
													<s:else>
														<input id="code02_0<s:property value="#st1.index + 1"/>" name='code02_item0<s:property value="#st1.index + 1"/>' value='<s:property value="code"/>' type="radio" /><s:property value="fieldname"/>
													</s:else>
						...
						<tr>
							...
							<td>
								<input type="file" name="updPicFile01" id="updPicFile01" style="width: 500px;"/><br />
						...
						<tr>
							...
							<td>
								<input type="file" name="updPicFile02" id="updPicFile02" style="width: 500px;"/><br />
						...
						<tr>
							...
							<td>
								<input type="file" name="updPicFile03" id="updPicFile03" style="width: 500px;"/><br />
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item12" id="item12" maxlength="64" cssStyle="width:300px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear1" id="gear1" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale1" id="scale1" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear2" id="gear2" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale2" id="scale2" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear3" id="gear3" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale3" id="scale3" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear4" id="gear4" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale4" id="scale4" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear5" id="gear5" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale5" id="scale5" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear6" id="gear6" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale6" id="scale6" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear7" id="gear7" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale7" id="scale7" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear8" id="gear8" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale8" id="scale8" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear9" id="gear9" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale9" id="scale9" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.gear10" id="gear10" maxlength="64" cssStyle="width:100px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale10" id="scale10" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.scale" id="scale" maxlength="64" cssStyle="width:50px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<label class="pdf10">%</label>
							</td>
						...
						<tr>
							...
							<td align="right">
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item16" id="item16" maxlength="15" cssStyle="width:80px;" theme="simple" ></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>						
						<tr>
							...
							<td align="right">
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updProductDto.item17" id="item17" maxlength="15" cssStyle="width:80px;" theme="simple" ></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>												
