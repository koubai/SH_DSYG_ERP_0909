...
<script type="text/javascript">
	...
	function queryList() {
		...
		document.mainform.action = '../product/queryTrackProductSelectPage.action';
	...
	function showUnit(id){
		...
		strCustomerId="";
		url += "?strProdoctid=" + id + "&strCustomerid=" + strCustomerId + "&strFlag=2" + "&date=" + encodeURI(new Date());
	...
	function addProductToParent(obj, id) {
		...
		getOpener().document.getElementById("product").value = product + id + ",";
		getOpener().document.getElementById("tmpproductinfo").value = productinfo + tradename + " " + typeno + " " + colorName + " " + item10 + "\n";
	}	
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../product/turnTrackProductSelectPage.action';
		document.mainform.submit();
	}
