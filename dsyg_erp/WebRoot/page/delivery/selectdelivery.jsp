...
<script type="text/javascript">
	...
	function addDelivery() {
		...
		var expressname = inputs[1].value;
		var expressaddress = inputs[2].value;
		var expressmanager = inputs[3].value;
	...
	function queryList() {
		...
		document.mainform.action = '../delivery/turnSelectDeliveryAction.action';
	...
	function changepagesize(pagesize) {
		...
		$("#selectStartIndex").attr("value", "0");
		document.mainform.action = '../delivery/querySelectDeliveryAction.action';
		document.mainform.submit();
	}
					...
					<s:iterator id="listSelectDelivery" value="listSelectDelivery" status="st1">
						...
						<s:else>
							...
							<td style="display: none;">
								...
								<input type="hidden" value="<s:property value="deliveryaddress1"/>"/>
								<input type="hidden" value="<s:property value="deliverymanager1"/>"/>
				...
				<tr>
					<td>
						<div class="btn">
							<div class="box1_left"></div>
							<div class="box1_center">
								<input type="button" class="input80" value="确定" onclick="addDelivery();"/>
							</div>
							<div class="box1_right"></div>
						</div>
						<div class="btn">
