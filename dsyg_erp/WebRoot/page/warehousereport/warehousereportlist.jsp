...
<script type="text/javascript">
	...
	function showDetail() {
		...
		if(id == "") {
			...
			var url = "<%=request.getContextPath()%>/warehousereport/showUpdWarehouseReportItemAction.action?updateWarehouseReportNo=" + id + "&date=" + encodeURI(new Date());
			...
			//document.mainform.action = "../sales/showUpdWarehouseReportAction.action?updSalesId=" + id;
	...
	function add() {
		document.mainform.action = '<c:url value="/warehousereport/showAddWarehouseReportAction.action"></c:url>';
		document.mainform.submit();
	}
	...
	function upd() {
		...
		if(id == "") {
			...
			document.mainform.action = '<c:url value="/warehousereport/showUpdWarehouseReportAction.action"></c:url>' + "?updateWarehouseReportNo=" + id;
			document.mainform.submit();
		}
	}
	...
	function del() {
		...
		if(id == "") {
			...
			if(confirm("确定删除该记录吗？")) {
				document.mainform.action = '<c:url value="/warehousereport/delWarehouseReportAction.action"></c:url>' + "?delWarehouseReportNo=" + id;
				document.mainform.submit();
			}
		}
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '<c:url value="/warehousereport/turnWarehouseReportPage.action"></c:url>';
		document.mainform.submit();
	}
	...
	function changepagesize(pagesize) {
		...
		document.mainform.action = '../warehousereport/queryWarehouseReportList.action';
		document.mainform.submit();
	}
		...
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<!-- <div class="searchbox update">
					<div class="box1">
						<label class="pdf10" style="width:160px">盘点报告编号检索 FROM</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strWarehouseReportNoLow" id="strWarehouseReportNoLow" cssStyle="width:135px;" maxlength="32" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
						<label>TO</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strWarehouseReportNoHigh" id="strWarehouseReportNoHigh" cssStyle="width:135px;" maxlength="32" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
				</div> -->
				<div class="searchbox update">
					<div class="box1" >
						<label class="pdf10" style="width:120px">盘点报告名:</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strWarehouseReportName" id="strWarehouseReportName" cssStyle="width:135px;" maxlength="128" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
				...
				<div class="data_table" style="padding:0px;">
					...
					<div class="tab_content" style="height: <s:property value="intPageSize * 35"/>px;">
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="listWarehouseReport" value="listWarehouseReport" status="st1">
								...
								<s:else>
									...
									<td><input name="radioKey" type="radio" value="<s:property value="warehousereportno"/>"/></td>
									<td><s:property value="page.pageSize * (page.nextIndex - 1) + #st1.index + 1"/></td>
									<!-- <td><s:property value="warehousereportno"/></td> -->
									<td>
										<div noWrap style="text-overflow:ellipsis;overflow:hidden">
											<s:property value="warehousereportname"/>
										</div>
									</td>
