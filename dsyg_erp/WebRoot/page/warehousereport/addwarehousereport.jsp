...
<title>库存盘点报告信息输入</title>
<script type="text/javascript">
	function add() {
		var id = $("#warehousereportno").val().trim();
		...
		if(confirm("确定提交吗？")) {
			document.mainform.action = '<c:url value="/warehousereport/addWarehouseReportAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
	<s:hidden name="addWarehouseReportDto.note" id="note"></s:hidden>
	<s:hidden name="addWarehouseReportDto.registerdate" id="registerdate"></s:hidden>
	...
	<s:hidden name="addWarehouseReportDto.warehousereportno" id="warehousereportno"></s:hidden>
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<s:textfield name="addWarehouseReportDto.warehousereportname" id="warehousereportname" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addWarehouseReportDto.handler" id="handler" cssStyle="width:350px;" maxlength="32" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="addWarehouseReportDto.showregisterdate"/>" maxlength="10" />
			...
			<tr>
				...
				<td>
					<textarea name="" id="tmpnote" cols="" rows="5" style="width:350px;"><s:property value="addWarehouseReportDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
