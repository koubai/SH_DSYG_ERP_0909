...
<script type="text/javascript">
	...
	function add() {
		document.mainform.action = '<c:url value="/supplier/showAddSupplierAction.action"></c:url>';
	...
	function upd() {
		...
		if(id == "") {
			...
			document.mainform.action = '<c:url value="/supplier/showUpdSupplierAction.action"></c:url>' + "?updateSupplierNo=" + id;
			document.mainform.submit();
		}
	}
	...
	function changepagesize(pagesize) {
		...
		document.mainform.action = '../supplier/querySupplierList.action';
		document.mainform.submit();
	}
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<div class="searchbox update">
					<div class="box1" >
						...
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strSupplierName" id="strSupplierName" cssStyle="width:135px;" maxlength="50" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
