		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				...
				<td>
					<s:if test='addCustomerDto.res03 == "2"'>
						<input type="radio" id="tmpRes03" name="addSupplierDto.res03" value='1' />贸易
						<input type="radio" name="addSupplierDto.res03" checked="checked" value='2'/>发展　
					</s:if>
					<s:else>
						<input type="radio" id="tmpRes03" name="addSupplierDto.res03" checked="checked" value='1' />贸易
						<input type="radio" name="addSupplierDto.res03" value='2'/>发展　
					</s:else>
			</tr>			
			<tr>
				...
				<td width="500">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addSupplierDto.res04" id="res04" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td width="500">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addSupplierDto.res02" id="res02" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
