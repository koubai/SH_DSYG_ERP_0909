...
<script type="text/javascript">
	function add() {
		...
		document.mainform.action = '<c:url value="/salesreport/addSalesReportAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
	<s:hidden name="addSalesReportDto.note" id="note"></s:hidden>
	<s:hidden name="addSalesReportDto.registerdate" id="registerdate"></s:hidden>
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<s:textfield name="addSalesReportDto.salesreportname" id="salesreportname" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						...
						<input type="hidden" id="customerid" value="<s:property value="addSalesReportDto.customerid"/>"/>
						<s:textfield name="addSalesReportDto.customername" id="customername" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addSalesReportDto.purpose" id="purpose" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addSalesReportDto.handler" id="handler" cssStyle="width:350px;" maxlength="32" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="addSalesReportDto.showregisterdate"/>" maxlength="10" />
			...
			<tr>
				...
				<td>
					<textarea name="" id="tmpnote" cols="" rows="5" style="width:350px;"><s:property value="addSalesReportDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
