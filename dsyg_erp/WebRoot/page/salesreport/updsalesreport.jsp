		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updateSalesReportDto.purpose" id="purpose" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updateSalesReportDto.handler" id="handler" cssStyle="width:350px;" maxlength="32" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="updateSalesReportDto.showregisterdate"/>" maxlength="10" />
			...
			<tr>
				...
				<td>
					...
					<a target="_blank" href="<s:property value="updateSalesReportDto.reporturl"/><s:property value="updateSalesReportDto.reportpath01"/>"><s:property value="updateSalesReportDto.reportpath01"/></a>
				</td>
			</tr>
			<tr>
				<td class="td_tittle">
				...
				<td>
					...
					<a target="_blank" href="<s:property value="updateSalesReportDto.reporturl"/><s:property value="updateSalesReportDto.reportpath02"/>"><s:property value="updateSalesReportDto.reportpath02"/></a>
				</td>
			</tr>
			<tr>
				<td class="td_tittle">
				...
				<td>
					...
					<a target="_blank" href="<s:property value="updateSalesReportDto.reporturl"/><s:property value="updateSalesReportDto.reportpath03"/>"><s:property value="updateSalesReportDto.reportpath03"/></a>
				</td>
			</tr>
			<tr>
				<td><label class="pdf10">备注</label></td>
				<td>
					<textarea name="" id="tmpnote" cols="" rows="5" style="width:350px;"><s:property value="updateSalesReportDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
