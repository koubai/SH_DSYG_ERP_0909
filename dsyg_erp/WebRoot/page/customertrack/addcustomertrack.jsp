...
<script type="text/javascript">
	function add() {
		...
		document.mainform.action = '<c:url value="/customertrack/addCustomerTrackAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST">
	<s:hidden name="addCustomerTrackDto.product" id="product"></s:hidden>
	<s:hidden name="addCustomerTrackDto.productinfo" id="productinfo"></s:hidden>
	<s:hidden name="addCustomerTrackDto.note" id="note"></s:hidden>
	<s:hidden name="addCustomerTrackDto.customermail1" id="customermail1"></s:hidden>
	<s:hidden name="addCustomerTrackDto.receivedate" id="receivedate"></s:hidden>
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addCustomerTrackDto.source" id="source" cssStyle="width:425px;" maxlength="16" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
						...
						<table class="trade_tab" width="85%" border="0">
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerTrackDto.customermanager1" id="customermanager1" cssStyle="width:250px;" maxlength="24" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerTrackDto.customertel1" id="customertel1" cssStyle="width:250px;" maxlength="30" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1">
										<div class="box1_left"></div>
										<div class="box1_center">
											<s:textfield name="addCustomerTrackDto.mail_pr1" id="mail_pr1" cssStyle="width:116px;" maxlength="29" theme="simple"></s:textfield>
										</div>
										<div class="box1_right"></div>
										<label>@</label>
										<div class="box1_left"></div>
										<div class="box1_center">
											<s:textfield name="addCustomerTrackDto.mail_suffix1" id="mail_suffix1" cssStyle="width:116px;" maxlength="30" theme="simple"></s:textfield>
										</div>
										<div class="box1_right"></div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerTrackDto.customeraddress1" id="customeraddress1" cssStyle="width:250px;" maxlength="40" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="box1_left"></div>
									<div class="box1_center">
										<s:textfield name="addCustomerTrackDto.customerfax1" id="customerfax1" cssStyle="width:250px;" maxlength="40" theme="simple"></s:textfield>
									</div>
									<div class="box1_right"></div>
								</td>
							</tr>
			...
			<tr>
				...
				<td>
					<div style="float:left;">
						<textarea name="" id="tmpproductinfo" cols="" rows="3" disabled="disabled" style="width:430px;"><s:property value="addCustomerTrackDto.productinfo"/></textarea>
					</div>
					<div class="btn">
						<div class="box1_left"></div>
						<div class="box1_center">
			...
			<%-- <tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<select name="addCustomerTrackDto.customertype" id="customertype" style="width: 120px;" onchange="selectCustomerType();">
							<s:if test='addCustomerTrackDto.customertype == 0'>
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<%-- <s:if test='addCustomerTrackDto.customertype == 0'>
							<s:textfield name="addCustomerTrackDto.handlerid" id="handlerid" disabled="true" maxlength="32" cssStyle="width:360px;" theme="simple"></s:textfield>
						</s:if>
						<s:else>
							<s:textfield name="addCustomerTrackDto.handlerid" id="handlerid" maxlength="32" cssStyle="width:360px;" theme="simple"></s:textfield>
						</s:else> --%>
						<input type="hidden" name="addCustomerTrackDto.handlerid" id="handlerid" value="<s:property value="addCustomerTrackDto.handlerid"/>"/>
						<s:textfield name="addCustomerTrackDto.handlername" id="handlername" maxlength="32" cssStyle="width:425px;" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
					<div class="btn">
						<div class="box1_left"></div>
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" id="tmpReceivedate" disabled="disabled" style="width:405px;" value="<s:property value="addCustomerTrackDto.showReceivedate"/>" />
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<select name="addCustomerTrackDto.status" id="status" style="width: 425px;">
							<s:if test='addCustomerTrackDto.status == 2'>
								<option value="1">请选择</option>
								<option value="2" selected="selected">成功</option>
								<option value="3">失败</option>
								<option value="4">进行中</option>
							</s:if>
							<s:elseif test='addCustomerTrackDto.status == 3'>
								<option value="1">请选择</option>
								<option value="2">成功</option>
								<option value="3" selected="selected">失败</option>
								<option value="4">进行中</option>
							</s:elseif>
							<s:elseif test='addCustomerTrackDto.status == 4'>
								<option value="1">请选择</option>
								<option value="2">成功</option>
								<option value="3">失败</option>
