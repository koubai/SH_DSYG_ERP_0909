...
<script type="text/javascript">
	...
	function add() {
		document.mainform.action = '<c:url value="/personal/showAddEtbPersonalAction.action"></c:url>';
	...
	function upd() {
		...
		if(id == "") {
			...
			document.mainform.action = '<c:url value="/personal/showUpdEtbPersonalAction.action"></c:url>' + "?updateUserNo=" + id;
			document.mainform.submit();
		}
	}
	...
	function del() {
		...
		if(id == "") {
			...
			if(confirm("确定删除该记录吗？")) {
				document.mainform.action = '<c:url value="/personal/delEtbPersonalAction.action"></c:url>' + "?delUserNo=" + id;
				document.mainform.submit();
			}
		}
	}
	...
	function exportExcel() {
		document.mainform.action = '<c:url value="/personal/exportEtbPersonalAction.action"></c:url>';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '<c:url value="/personal/turnEtbPersonalPage.action"></c:url>';
		document.mainform.submit();
	}
	...
	function changepagesize(pagesize) {
		...
		document.mainform.action = '../personal/queryEtbPersonalList.action';
		document.mainform.submit();
	}
	...
	<div id="containermain">
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				...
				<div class="searchbox update">
					<div class="box1" >
						<label class="pdf10" style="width:120px">员工姓名</label>
						<div class="box1_left"></div>
						<div class="box1_center">
							<s:textfield name="strUserName" id="strUserName" cssStyle="width:135px;" maxlength="4" theme="simple"></s:textfield>
						</div>
						<div class="box1_right"></div>
					</div>
				...
				<div class="data_table" style="padding:0px;">
					...
					<div class="tab_content" style="height: <s:property value="intPageSize * 35"/>px;">
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							...
							<s:iterator id="listPersonal" value="listPersonal" status="st1">
								...
								<s:else>
									...
									<td><input name="radioKey" type="radio" value="<s:property value="userno"/>"/></td>
