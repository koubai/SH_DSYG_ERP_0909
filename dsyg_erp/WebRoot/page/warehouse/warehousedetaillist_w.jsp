...
<script type="text/javascript">
	...
	function queryList() {
		...
		if (sTheme =="" && sKeyword ==""){
			if(confirm("没有输入关键字，确认需要全件检索吗？")) {
				document.mainform.action = '../warehouse/queryWarehouseDetailWAction.action';
			}
		}else
			document.mainform.action = '../warehouse/queryWarehouseDetailWAction.action';			
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../warehouse/turnWarehouseDetailWAction.action';
		document.mainform.submit();
	}
					...
					<div class="tab_content" style="height: <s:property value="intPageSize * 35"/>px;">
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							<tr class="tittle">
								...
								<td width="80">库存总数量</td>
								<td width="80">深圳库存数</td>
								<!-- <td width="60">差数</td>
								<td width="60">深圳差数</td> -->
								<td width="80">采购数量</td>
