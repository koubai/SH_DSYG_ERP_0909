...
<script type="text/javascript">
	function upd() {
		...
		document.mainform.action = '<c:url value="/assets/updEtbAssetsAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST">
	<s:hidden name="updateAssetsDto.note" id="note"></s:hidden>
	<s:hidden name="updateAssetsDto.registerdate" id="registerdate"></s:hidden>
	<div id="container" style="width: 100%; height: 100%;">
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td width="500">&nbsp;<s:property value="updateAssetsDto.assetsno"/></td>
			</tr>
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<s:textfield name="updateAssetsDto.assetsname" id="assetsname" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updateAssetsDto.purpose" id="purpose" cssStyle="width:350px;" maxlength="64" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updateAssetsDto.handler" id="handler" cssStyle="width:350px;" maxlength="32" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="updateAssetsDto.showregisterdate"/>" maxlength="10" />
			...
			<tr>
				<td>备注</td>
				<td>
					<textarea name="" id="tmpnote" cols="" rows="5" style="width:350px;"><s:property value="updateAssetsDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
