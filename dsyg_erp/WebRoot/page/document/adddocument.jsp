...
<s:form id="mainform" name="mainform" method="POST">
	...
	<s:hidden name="addDocumentDto.registerdate" id="registerdate"></s:hidden>
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" disabled="disabled" style="width: 100px;" id="tmpregisterdate" value="<s:property value="addDocumentDto.showregisterdate"/>" maxlength="10" />
