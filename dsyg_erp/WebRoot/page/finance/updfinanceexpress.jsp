...
<script type="text/javascript">
	function upd() {
		if(checkItem()) {
			if(confirm("确定提交吗？")) {
				document.mainform.action = "../finance/updFinanceExpressAction.action";
	...
	<div id="containermain">
		<div class="content">
			...
			<s:form id="mainform" name="mainform" method="POST">
				<s:hidden name="updFinanceDto.customerid" id="expressid"></s:hidden>
				<s:hidden name="updFinanceDto.receiptdate" id="receiptdate"></s:hidden>

				<s:hidden name="updFinanceDto.res01" id="customerid"></s:hidden>
				...
				<s:hidden name="updFinanceDto.note" id="note"></s:hidden>
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.customername" id="expressname" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="btn">
									<div class="box1_left"></div>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.customeraddress" id="expressaddress" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
							<td align="right">
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.amount" id="amount" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.customermanager" id="expressmanager" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.customertel" id="expresstel" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
							<td align="right">
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.customermail" id="expressmail" cssStyle="width:300px;" maxlength="16" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="box1_left"></div>
								<div class="box1_center">
									<s:textfield name="updFinanceDto.res02" id="customername" maxlength="32" cssStyle="width:300px;" theme="simple"></s:textfield>
								</div>
								<div class="box1_right"></div>
								<div class="btn">
									<div class="box1_left"></div>
						...
						<tr>
							...
							<td colspan="3">
								<textarea rows="5" cols="150" style="width:900px;" id="tempNote"><s:property value="updFinanceDto.note"/></textarea>
							</td>
						</tr>
					</table>
				</div>
