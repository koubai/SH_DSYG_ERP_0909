...
<script type="text/javascript">
	...
	function auditorbillno() {
		...
		if(confirm("确认提交吗？")) {
			document.mainform.action = "../finance/updFinanceOutStatusBillnoAction.action?updWarehouserptId=" + id + "&updWarehouserptStatus=" + status;
			document.mainform.submit();
		}
	}
	...
	function queryList() {
		setQueryDate();
		document.mainform.action = '../finance/queryFinanceOutAction.action';
		document.mainform.submit();
	}
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../finance/turnFinanceOutAction.action';
		document.mainform.submit();
	}
