...
<script type="text/javascript">
	function add() {
		...
		document.mainform.action = '<c:url value="/issue/addIssueAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST">
	<s:hidden name="addIssueDto.issuename" id="issuename"></s:hidden>
	<s:hidden name="addIssueDto.note" id="note"></s:hidden>
	<s:hidden name="addIssueDto.result" id="result"></s:hidden>
	<s:hidden name="addIssueDto.issuedate" id="issuedate"></s:hidden>
	<div id="container" style="width: 100%; height: 100%;">
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td>
					<textarea name="" id="tmpissuename" cols="" rows="3" style="width:425px;"><s:property value="addIssueDto.issuename"/></textarea>
				</td>
			</tr>
			<tr>
				<td>事件日期</td>
				<td>
					...
					<div class="box1_center date_input">
						<input type="text" id="tmpIssuedate" disabled="disabled" style="width:405px;" value="<s:property value="addIssueDto.showIssuedate"/>" />
			...
			<%-- <tr>
				...
				<td>
					...
					<div class="box1_center">
						<input type="hidden" name="addIssueDto.productid" id="productid" value="<s:property value="addIssueDto.productid"/>"/>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<select name="addIssueDto.customertype" id="customertype" style="width: 425px;" onchange="selectCustomerType();">
							<s:if test='addIssueDto.customertype == 1'>
								<option value="0">请选择</option>
								<option value="1" selected="selected">供应商</option>
								<option value="2">客户</option>
							</s:if>
							<s:elseif test='addIssueDto.customertype == 2'>
								<option value="0">请选择</option>
			...
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						...
						<input type="hidden" name="addIssueDto.customerid" id="customerid" value="<s:property value="addIssueDto.customerid"/>"/>
						<s:if test='addIssueDto.customertype == 1 || addIssueDto.customertype == 2'>
							<s:textfield name="addIssueDto.customername" id="customername" maxlength="64" cssStyle="width:425px;" theme="simple"></s:textfield>
						</s:if>
						<s:else>
							<s:textfield name="addIssueDto.customername" id="customername" disabled="true" maxlength="64" cssStyle="width:425px;" theme="simple"></s:textfield>
						</s:else>
					</div>
					<div class="box1_right"></div>
					<div class="btn">
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<input type="hidden" name="addIssueDto.handlerid" id="handlerid" value="<s:property value="addIssueDto.handlerid"/>"/>
						<s:textfield name="addIssueDto.handlername" id="handlername" maxlength="32" cssStyle="width:425px;" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
					<div class="btn">
						<div class="box1_left"></div>
			...
			<tr>
				<td>处理结果</td>
				<td>
					<textarea name="" id="tmpresult" cols="" rows="3" style="width:425px;"><s:property value="addIssueDto.result"/></textarea>
				</td>
			</tr>
			<tr>
				<td>备注</td>
				<td>
					<textarea name="" id="tmpnote" cols="" rows="3" style="width:425px;"><s:property value="addIssueDto.note"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
