...
<script type="text/javascript">
	...
	//查询数据
	function queryList() {
		document.mainform.action = '../sales/queryRemainSalesAction.action';
	...
	function changePage(pageNum) {
		...
		document.mainform.action = '../sales/turnRemainSalesAction.action';
		document.mainform.submit();
	}
				...
				<div class="searchbox">
					<div class="box1">
						...
						<div class="box1_center date_input">
							<s:textfield name="strRemainCustomername" cssStyle="width:200px;" id="strRemainCustomername" theme="simple"></s:textfield>
						</div>
					...
					<div class="tab_content" style="height: <s:property value="intPageSize * 35"/>px;">
						<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
							<tr class="tittle">
								...
								<td width="60">颜色</td>
								<td width="60">包装</td>
								<td width="80">未出库数量</td>
							</tr>
							<s:iterator id="remainSalesItemList" value="remainSalesItemList" status="st1">
								...
								<s:else>
									...
									<td>
										<s:iterator id="colorList" value="colorList" status="st3">
											<s:if test="%{colorList[#st3.index].code == remainSalesItemList[#st1.index].color}">
												<s:property value="fieldname"/>
											</s:if>
										</s:iterator>
									</td>
									<td>
										<s:if test='%{remainSalesItemList[#st1.index].packaging == "0"}'>整箱</s:if>
										<s:elseif test='%{remainSalesItemList[#st1.index].packaging == "1"}'>乱尺</s:elseif>
										<s:else>
